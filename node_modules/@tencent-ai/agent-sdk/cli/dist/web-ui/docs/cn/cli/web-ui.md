...
终端会显示二维码和 URL。用手机扫码或在浏览器中打开 URL。详见[远程控制](remote-control.md)文档。
...
完整的 API 参考请见 [HTTP API 文档](http-api.md)。
...
- [远程控制](remote-control.md) — 通过 Gateway 和 Tunnel 启动 Web UI
- [HTTP API](http-api.md) — 完整的 REST API 文档
- [ACP 协议](acp.md) — IDE 集成的 Agent Client Protocol
- [设置](settings.md) — 配置选项
