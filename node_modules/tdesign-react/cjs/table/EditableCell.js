...
var toArray = require('../_chunks/dep-b974cb6b.js');
...
var EditableCell = function EditableCell(props) {
  ...
  var getCurrentRow = function getCurrentRow(row2, colKey, value) {
    ...
    var _ref = colKey.split(".") || [],
      ...
      firstKey = _ref2[0],
      restKeys = _arrayLikeToArray(_ref2).slice(1);
  ...
  var cellValue = get.get(row, col.colKey);
  var currentRow = getCurrentRow(row, col.colKey, editValue);
  ...
  var onEditChange = function onEditChange(val) {
    ...
    setEditValue(val);
    var editedRow = getCurrentRow(props.row, props.col.colKey, val);
