...
var helper = require('../_chunks/dep-441171c7.js');
var affix_index = require('../affix/index.js');
var hooks_useDefaultProps = require('../hooks/useDefaultProps.js');
var hooks_useDomRefMount = require('../hooks/useDomRefMount.js');
...
require('../_chunks/dep-245edab6.js');
...
require('../_chunks/dep-972a6a5e.js');
require('../hooks/useDeepEffect.js');
require('../hooks/usePrevious.js');
require('../_chunks/dep-c9767082.js');
require('../_chunks/dep-5ccfcf73.js');
require('../_chunks/dep-12a23001.js');
require('../_chunks/dep-c854710a.js');
require('../_chunks/dep-6bb62fef.js');
require('../_chunks/dep-d5463fdc.js');
require('../_chunks/dep-d8b91e39.js');
...
require('../_chunks/dep-bc02a9af.js');
...
var BaseTable = /*#__PURE__*/React.forwardRef(function (originalProps, ref) {
  ...
  var borderWidth = props.bordered ? 1 : 0;
  ...
  var _useState3 = React.useState(true),
    ...
    supportMinWidth = _useState4[0],
    setSupportMinWidth = _useState4[1];
  ...
  var _useDomRefMount = hooks_useDomRefMount["default"](affixHeaderRef),
    onAffixHeaderMount = _useDomRefMount.onMount;
  ...
  React.useEffect(function () {
    setSupportMinWidth(!helper.isFirefox() && !helper.isSafari());
  }, []);
  ...
  React.useEffect(function () {
    ...
    if (props.horizontalScrollAffixedBottom) {
      bottom2 -= scrollbarWidth + borderWidth;
    }
  ...
  var virtualScrollParams = React.useMemo(function () {
    ...
    if (props.firstFullRow) {
      var firstFullRowData = {
        __VIRTUAL_FAKE_DATA: "FIRST_FULL_ROW"
      };
      virtualData = [firstFullRowData].concat(data);
    }
  ...
  var scrollColumnIntoView = function scrollColumnIntoView(colKey) {
    ...
    var fixedThDom = tableContentRef.current.querySelectorAll("th.".concat(classPrefix, "-table__cell--fixed-left"));
    var totalWidth = 0;
  ...
  React.useImperativeHandle(ref, function () {
    return {
      ...
      onAffixHeaderMount: onAffixHeaderMount,
    ...
    return /* @__PURE__ */React__default["default"].createElement("colgroup", null, finalColumns.map(function (col, index) {
      ...
      if (col.minWidth) {
        if (supportMinWidth) {
          ...
          style2.width = table_hooks_useStyle.formatCSSUnit(col.minWidth);
        }
      }
  ...
  var renderFixedHeader = function renderFixedHeader() {
    ...
    var affixedHeader = Boolean((headerAffixedTop || virtualConfig.isVirtualScroll) && tableWidth) && /* @__PURE__ */React__default["default"].createElement("div", {
      ...
      style: _objectSpread(_objectSpread({}, tableElementStyles), {}, {
        width: tableElmWidth ? "".concat(tableElmWidth, "px") : void 0
      })
  ...
  var renderAffixedFooter = function renderAffixedFooter() {
    ...
    var totalMarginTop = tableFootHeight + marginScrollbarWidth;
    var hasFooter = ((_props$footData = props.footData) === null || _props$footData === void 0 ? void 0 : _props$footData.length) || props.footerSummary;
    var affixedFooter = Boolean((virtualConfig.isVirtualScroll || props.footerAffixedBottom) && hasFooter && tableWidth) && /* @__PURE__ */React__default["default"].createElement(affix_index.Affix, _objectSpread(_objectSpread({
  ...
  var tableContent = /* @__PURE__ */React__default["default"].createElement("div", {
    ...
    className: classNames__default["default"](tableElmClasses),
    style: _objectSpread(_objectSpread({}, tableElementStyles), {}, {
      width: resizable && isWidthOverflow && tableElmWidth ? "".concat(tableElmWidth, "px") : tableElementStyles.width
    })
  ...
  var affixedHeaderContent = React.useMemo(renderAffixedHeader, [].concat(headUseMemoDependencies, [showAffixHeader, tableWidth, tableElmWidth, affixHeaderRef, borderWidth, tableElmClasses, tableElementStyles, columns, showHeader, props.headerAffixedTop]));
  var affixedFooterContent = React.useMemo(renderAffixedFooter, [showAffixFooter, isFixedHeader, rowAndColFixedPosition, spansAndLeafNodes, columns, thWidthList, tableBaseClass, tableElementStyles, tableElmWidth, affixFooterRef, borderWidth, isWidthOverflow, scrollbarWidth, tableElmClasses, tableFootHeight, tableWidth, virtualConfig.isVirtualScroll, props.rowKey, props.footData, props.rowAttributes, props.rowClassName, props.footerSummary, props.footerAffixedBottom, props.rowspanAndColspanInFooter]);
