...
var getScrollbarWidth = require('../../_chunks/dep-972a6a5e.js');
...
var xorWith = require('../../_chunks/dep-c9767082.js');
...
function useFixed(props, finalColumns, affixRef) {
  ...
  var columns = props.columns,
    ...
    columnResizable = props.resizable;
  ...
  var _useState9 = React.useState(0),
    ...
    tableElmWidth = _useState0[0],
    setTableElmWidthState = _useState0[1];
  var _useState1 = React.useState(6),
  ...
  var _useState11 = React.useState(function () {
    ...
    rowAndColFixedPosition = _useState12[0],
    setRowAndColFixedPosition = _useState12[1];
  var _useState13 = React.useState({
      left: false,
      right: false
    }),
    _useState14 = slicedToArray._slicedToArray(_useState13, 2),
    showColumnShadow = _useState14[0],
    setShowColumnShadow = _useState14[1];
  var _useState15 = React.useState({
      left: 0,
      top: 0
    }),
    _useState16 = slicedToArray._slicedToArray(_useState15, 2),
    virtualScrollHeaderPos = _useState16[0],
    setVirtualScrollHeaderPos = _useState16[1];
  var _useState17 = React.useState(false),
    _useState18 = slicedToArray._slicedToArray(_useState17, 2),
    isFixedColumn = _useState18[0],
    setIsFixedColumn = _useState18[1];
  var _useState19 = React.useState(false),
    _useState20 = slicedToArray._slicedToArray(_useState19, 2),
    isFixedRightColumn = _useState20[0],
    setIsFixedRightColumn = _useState20[1];
  var _useState21 = React.useState(false),
    _useState22 = slicedToArray._slicedToArray(_useState21, 2),
    isFixedLeftColumn = _useState22[0],
    setIsFixedLeftColumn = _useState22[1];
  ...
  var updateTableWidth = function updateTableWidth() {
    ...
    var tRef = tableContentRef.current;
    if (!tRef) return;
  ...
  var updateThWidthListHandler = function updateThWidthListHandler() {
    ...
    var thead = (_tableContentRef$curr = tableContentRef.current) === null || _tableContentRef$curr === void 0 ? void 0 : _tableContentRef$curr.querySelector("thead");
    if (!thead) return;
  ...
  var getThWidthList = function getThWidthList(type) {
    if (type === "calculate") {
      var _tableContentRef$curr2;
      var trList = (_tableContentRef$curr2 = tableContentRef.current) === null || _tableContentRef$curr2 === void 0 || (_tableContentRef$curr2 = _tableContentRef$curr2.querySelector("thead")) === null || _tableContentRef$curr2 === void 0 ? void 0 : _tableContentRef$curr2.children;
  ...
  hooks_useDeepEffect["default"](updateFixedStatus, [data, columns, bordered, tableLayout, tableContentWidth, isFixedHeader, isWidthOverflow, isFixedColumn, fixedRows, firstFullRow, lastFullRow, tableContentRef]);
  hooks_useDeepEffect["default"](function () {
    if (isFixedColumn) {
      updateColumnFixedShadow(tableContentRef.current);
    }
  }, [isFixedColumn, columns, tableContentRef]);
  hooks_useDeepEffect["default"](updateFixedHeader, [maxHeight, data, columns, bordered, tableContentRef]);
  hooks_useDeepEffect["default"](function () {
  ...
  React.useEffect(function () {
    ...
    return table_utils.resizeObserverElement(tableContentRef.current, refreshTable);
  }, []);
  hooks_useDeepEffect["default"](function () {
    ...
    if (isWatchResize && helper.getIEVersion() < 11 || !hasResizeObserver) {
      _util_listener.on(window, "resize", refreshTable);
    }
    return function () {
      if (isWatchResize && helper.getIEVersion() < 11 || !hasResizeObserver) {
        if (typeof window !== "undefined") {
          _util_listener.off(window, "resize", refreshTable);
        }
      }
    };
  }, [isFixedColumn, isFixedHeader, isWidthOverflow, scrollbarWidth, notNeedThWidthList, data]);
  React.useEffect(function () {
    var tableContent = tableContentRef.current;
    if (!tableContent) return;
    var onAnimationEnd = function onAnimationEnd(e) {
      var target = e.target;
      if (!(target !== null && target !== void 0 && target.contains(tableContent))) return;
      refreshTable();
    };
    _util_listener.on(document, "animationend", onAnimationEnd, {
      capture: true
    });
    return function () {
      _util_listener.off(document, "animationend", onAnimationEnd, {
        capture: true
      });
    };
  }, []);
