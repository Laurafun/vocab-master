...
var format = require('../_chunks/dep-0727b240.js');
var utils = require('../_chunks/dep-471797a1.js');
...
var isArray = require('../_chunks/dep-3669c576.js');
var isFunction = require('../_chunks/dep-7d0f2990.js');
...
require('../_chunks/dep-6101c9a7.js');
...
require('../_chunks/dep-d3391912.js');
require('../_chunks/dep-9f9a5512.js');
require('../_chunks/dep-6bb62fef.js');
require('../_chunks/dep-c5773a72.js');
...
require('../_chunks/dep-e3d07874.js');
require('tdesign-icons-react');
require('../_util/parseTNode.js');
require('../hooks/useControlled.js');
require('../_util/noop.js');
require('../_chunks/dep-8a355d19.js');
require('../_chunks/dep-95452e8e.js');
...
require('../_chunks/dep-5dce9426.js');
require('../locale/LocalReceiver.js');
require('../config-provider/ConfigProvider.js');
require('../_chunks/dep-2a78f9d1.js');
require('../_chunks/dep-b4981e0b.js');
require('../_chunks/dep-5bda5085.js');
require('../_chunks/dep-c6cf3e97.js');
require('../_chunks/dep-d8b2ac22.js');
require('../input/defaultProps.js');
require('../input/InputGroup.js');
require('../input/useLengthLimit.js');
require('../_chunks/dep-441171c7.js');
require('../_chunks/dep-e38e8bcb.js');
...
require('../_chunks/dep-a13eaad1.js');
require('../_chunks/dep-dc932917.js');
require('../_chunks/dep-08764f85.js');
require('../_chunks/dep-ff12781e.js');
...
require('../_chunks/dep-1dc914fd.js');
...
require('../_chunks/dep-e8758e6e.js');
...
require('../_chunks/dep-27788b55.js');
...
require('../_chunks/dep-86e37296.js');
require('../tag/defaultProps.js');
require('../tag/Tag.js');
require('../_chunks/dep-f1480eac.js');
require('../tag/CheckTagGroup.js');
require('../tag-input/useTagScroll.js');
require('../tag-input/utils/tagInputScroll.js');
require('../select-input/useSingle.js');
require('../_chunks/dep-a8ecb564.js');
require('../_chunks/dep-9811599f.js');
require('../_chunks/dep-2c365a99.js');
require('../_chunks/dep-875a8f1b.js');
require('../_chunks/dep-7a4e9489.js');
require('../_chunks/dep-d5463fdc.js');
...
require('../_chunks/dep-086c3234.js');
require('../_chunks/dep-3c46c22b.js');
require('../_chunks/dep-7a245abb.js');
require('../pagination/PaginationMini.js');
require('./hooks/useSelectRange.js');
require('./base/Table.js');
require('./base/Cell.js');
require('../_chunks/dep-7c762c12.js');
...
var DateRangePicker = /*#__PURE__*/React.forwardRef(function (originalProps, ref) {
  ...
  var className = props.className,
    ...
    range = props.range,
    panelActiveDate = props.panelActiveDate,
    cell = props.cell,
    onPick = props.onPick,
  ...
  var _useRange = datePicker_hooks_useRange["default"](props),
    ...
    isSwitchTimeMode = _useRange.isSwitchTimeMode;
  ...
  var handleSyncPanelValue = function handleSyncPanelValue(value2) {
    var nextMonth = value2.map(function (v) {
      return format.parseToDayjs(v, format$1).month();
    });
    var nextYear = value2.map(function (v) {
  ...
  var onTriggerNeedConfirm = hooks_useLatest["default"](function () {
    ...
    if (notValidIndex === -1 && nextValue.length === 2) {
      ...
      if (currentValue[0] !== nextValue[0] || currentValue[1] !== nextValue[1]) {
        var formattedValue = format.formatDate(nextValue, {
          format: format$1,
  ...
  React.useEffect(function () {
    ...
    if (popupVisible) {
      ...
      if (!value.length) {
        if (range && isArray.isArray(range) || panelActiveDate) {
          ...
          if (isArray.isArray(range)) {
            var _range = slicedToArray._slicedToArray(range, 2),
              first = _range[0],
              second = _range[1];
            if (isArray.isArray(first) || isFunction.isFunction(first) || isArray.isArray(second) || isFunction.isFunction(second)) {
              startRange = first;
              endRange = second;
            }
          }
          var startRangeBounds = utils.getRangeBounds(startRange);
          var endRangeBounds = utils.getRangeBounds(endRange);
          ...
          var startPanelActiveDate = panelActiveDate;
          var endPanelActiveDate = panelActiveDate;
          if (isArray.isArray(panelActiveDate)) {
            var _panelActiveDate = slicedToArray._slicedToArray(panelActiveDate, 2);
            startPanelActiveDate = _panelActiveDate[0];
            endPanelActiveDate = _panelActiveDate[1];
          }
          ...
          var nextYear = [leftYear !== null && leftYear !== void 0 ? leftYear : defaultYear[0], rightYear !== null && rightYear !== void 0 ? rightYear : defaultYear[1]];
          var nextMonth = [leftMonth !== null && leftMonth !== void 0 ? leftMonth : defaultMonth[0], rightMonth !== null && rightMonth !== void 0 ? rightMonth : defaultMonth[1]];
          if (nextYear[0] === nextYear[1] && nextMonth[0] === nextMonth[1] && !enableTimePicker) {
            if (startRange === endRange) {
              if (mode === "year") nextYear[1] += 10;else if (mode === "month" || mode === "quarter") nextYear[1] += 1;else nextMonth[1] += 1;
            }
          }
          setYear(nextYear);
          setMonth(nextMonth);
        } else {
          var _initYearMonthTime2 = format.initYearMonthTime({
              value: value,
              mode: mode,
              format: format$1,
              enableTimePicker: enableTimePicker
          ...
          setYear(_defaultYear);
          setMonth(_defaultMonth);
        }
      } else if (value.length === 2 && (!enableTimePicker || isSwitchTimeMode)) {
        handleSyncPanelValue(value);
      } else {
        var _nextYear = value.map(function (v) {
          return format.parseToDayjs(v, format$1).year();
        });
        if (_nextYear.length === 1) _nextYear = [_nextYear[0], _nextYear[0]];
        var _nextMonth = value.map(function (v) {
          return format.parseToDayjs(v, format$1).month();
        });
        if (_nextMonth.length === 1) _nextMonth = [_nextMonth[0], Math.min(_nextMonth[0] + 1, 11)];
        setYear(_nextYear);
        setMonth(_nextMonth);
      }
    } else {
  ...
  function onJumperClick(_ref2) {
    ...
    setYear(nextYear);
    setMonth(nextMonth);
    var yearChanged = year[partialIndex] !== nextYear[partialIndex];
    var monthChanged = month[partialIndex] !== nextMonth[partialIndex];
    if (yearChanged) {
      ...
      (_props$onYearChange = props.onYearChange) === null || _props$onYearChange === void 0 || _props$onYearChange.call(props, {
        ...
        trigger: trigger === "current" ? "today" : "year-".concat(datePicker_utils.triggerMap[trigger])
      });
    }
    if (monthChanged) {
      ...
      (_props$onMonthChange = props.onMonthChange) === null || _props$onMonthChange === void 0 || _props$onMonthChange.call(props, {
        ...
        trigger: trigger === "current" ? "today" : "month-".concat(datePicker_utils.triggerMap[trigger])
      });
    }
  }
  function onTimePickerChange(val, context) {
    var _context$activeIndex;
    ...
    var currentIndex = (_context$activeIndex = context.activeIndex) !== null && _context$activeIndex !== void 0 ? _context$activeIndex : activeIndex;
    var nextInputValue = toConsumableArray._toConsumableArray(inputValue);
    var changedInputValue = inputValue[currentIndex];
    var currentDate = !dayjs__default["default"](changedInputValue, format$1).isValid() ? dayjs__default["default"]().year(year[currentIndex]).month(month[currentIndex]) : dayjs__default["default"](changedInputValue, format$1);
    var nextHours = hours;
