...
var MenuTree = /*#__PURE__*/function () {
  function MenuTree(children) {
    ...
    createClass._classCallCheck(this, MenuTree);
    defineProperty._defineProperty(this, "menuMap", /* @__PURE__ */new Map());
    defineProperty._defineProperty(this, "expandedSet", /* @__PURE__ */new Set());
    this.buildTree(children);
    this.expandMutex = expandMutex;
  }
  return createClass._createClass(MenuTree, [{
    key: "buildTree",
    ...
    value: function expandNode(value) {
      ...
      if (isCurrExpanded) {
        ...
        var toClose = /* @__PURE__ */new Set([value].concat(toConsumableArray._toConsumableArray(descendants)));
