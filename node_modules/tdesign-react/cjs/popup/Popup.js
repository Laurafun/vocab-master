...
var Popup = /*#__PURE__*/React.forwardRef(function (originalProps, ref) {
  ...
  function handleExited() {
    ...
    if (!destroyOnClose && popupElement) popupElement.style.display = "none";else setPopupElement(null);
  }
  ...
  function updatePopper() {
    ...
    if (!_util_style.canUseDocument || !popper || !visible) return;
    try {
      ...
      if (root && root instanceof ShadowRoot) {
        ...
        var isHidden = parent !== document.body || computedStyle.display === "none" || computedStyle.visibility === "hidden" || computedStyle.opacity === "0";
        if (!isHidden) {
          if (popper.state) popper.state.elements.reference = triggerEl;
          popper.update();
        } else {
