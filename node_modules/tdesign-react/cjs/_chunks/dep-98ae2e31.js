...
var objectWithoutProperties = require('./dep-e3d07874.js');
var React = require('react');
var classNames = require('classnames');
var constants = require('./dep-b832fa0a.js');
var _util_noop = require('../_util/noop.js');
var hooks_usePersistFn = require('../hooks/usePersistFn.js');
var message_MessageClose = require('../message/MessageClose.js');
var message_MessageIcon = require('../message/MessageIcon.js');
var message_useMessageClass = require('../message/useMessageClass.js');
...
function getFadeInKeyframes(placement, offsetWidth, offsetHeight) {
  if (!constants.PLACEMENT_LIST.includes(placement)) return null;
...
var MessageComponent = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var _otherProps$theme = otherProps.theme,
    theme = _otherProps$theme === void 0 ? "info" : _otherProps$theme,
    ...
    onCloseBtnClick = _otherProps$onCloseBt === void 0 ? _util_noop["default"] : _otherProps$onCloseBt,
    _otherProps$onDuratio = otherProps.onDurationEnd,
    onDurationEnd = _otherProps$onDuratio === void 0 ? _util_noop["default"] : _otherProps$onDuratio,
    _otherProps$onClose = otherProps.onClose,
    onClose = _otherProps$onClose === void 0 ? _util_noop["default"] : _otherProps$onClose,
    duration = otherProps.duration;
  var _useState = React.useState(false),
    _useState2 = slicedToArray._slicedToArray(_useState, 2),
    isHovering = _useState2[0],
    setIsHovering = _useState2[1];
  var onCloseFn = hooks_usePersistFn.usePersistFn(onClose);
  var onDurationEndFn = hooks_usePersistFn.usePersistFn(onDurationEnd);
  var onCloseBtnClickFn = hooks_usePersistFn.usePersistFn(onCloseBtnClick);
  ...
  }, icon === true ? /* @__PURE__ */React__default["default"].createElement(message_MessageIcon["default"], {
    theme: theme
  }) : icon, content ? content : children, /* @__PURE__ */React__default["default"].createElement(message_MessageClose["default"], {
    closeBtn: closeBtn,
...
//# sourceMappingURL=dep-98ae2e31.js.map
