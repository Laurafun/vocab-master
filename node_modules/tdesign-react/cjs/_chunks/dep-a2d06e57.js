...
var observe = require('./dep-245edab6.js');
...
var radio_useKeyboard = require('../radio/useKeyboard.js');
...
var RadioGroup = function RadioGroup(originalProps) {
  ...
  var props = hooks_useDefaultProps["default"](originalProps, radio_defaultProps.radioGroupDefaultProps);
  ...
  radio_useKeyboard["default"](radioGroupRef, setInternalValue);
  ...
  React.useEffect(function () {
    ...
    var observer = observe.observe(radioGroupRef.current, null, calcBarStyle, 0);
  ...
  return /* @__PURE__ */React__default["default"].createElement(common_Check.CheckContext.Provider, {
    ...
    ref: radioGroupRef,
    style: style,
    className: classNames__default["default"]("".concat(classPrefix, "-radio-group"), sizeMap[size], className, defineProperty._defineProperty(defineProperty._defineProperty(defineProperty._defineProperty(defineProperty._defineProperty({}, "".concat(classPrefix, "-radio-group__outline"), variant === "outline"), "".concat(classPrefix, "-radio-group--filled"), variant.includes("filled")), "".concat(classPrefix, "-radio-group--primary-filled"), variant === "primary-filled"), "".concat(classPrefix, "-radio-group--vertical"), direction === "vertical"))
...
//# sourceMappingURL=dep-a2d06e57.js.map
