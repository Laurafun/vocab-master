...
var defineProperty = require('./dep-8b3e7195.js');
var index = require('./dep-1dc914fd.js');
var slicedToArray = require('./dep-1f9ec5f8.js');
var React = require('react');
var classNames = require('classnames');
var tdesignIconsReact = require('tdesign-icons-react');
var transform = require('./dep-82f9d6d6.js');
var isArray = require('./dep-3669c576.js');
var isString = require('./dep-1d0ec457.js');
var number = require('./dep-a4e109a7.js');
...
var isFunction = require('./dep-7d0f2990.js');
...
var ImageModalMini = function ImageModalMini(props) {
  ...
  return /* @__PURE__ */React__default["default"].createElement(dialog_index.Dialog, {
    className: classNames__default["default"]("".concat(classPrefix, "-image-viewer__dialog"), className),
    ...
    footer: footer,
    onClose: onClose
  }, /* @__PURE__ */React__default["default"].createElement(ImageModalMiniContent, _objectSpread$1({}, props)));
};
...
var ImageModalItem = /*#__PURE__*/React__default["default"].forwardRef(function (_ref2, ref) {
  ...
  var modalBoxRef = React.useRef(null);
  ...
  var _usePosition = imageViewer_hooks_usePosition["default"](displayRef),
    ...
    positionRef = _usePosition.positionRef,
    setPosition = _usePosition.setPosition,
    resetPosition = _usePosition.resetPosition,
    isDraggingRef = _usePosition.isDraggingRef;
  var preImgStyle = {
    transform: "rotateZ(".concat(rotateZ, "deg) scale(").concat(scale, ")"),
  ...
  var transitioningClass = "".concat(classPrefix, "-image-viewer__modal-box--transitioning");
  var transitionEndHandlerRef = React.useRef(null);
  var fallbackTimerRef = React.useRef();
  var cleanupTransition = React.useCallback(function () {
    var modalBox = modalBoxRef.current;
    ...
    modalBox === null || modalBox === void 0 || modalBox.classList.remove(transitioningClass);
  }, [transitioningClass]);
  var enableTransition = React.useCallback(function () {
    var modalBox = modalBoxRef.current;
    if (!modalBox) return;
  ...
  var createSvgShadow = React.useCallback(/*#__PURE__*/function () {
    var _ref3 = index._asyncToGenerator(/*#__PURE__*/index.regenerator.mark(function _callee(url) {
      var _element$classList;
      var response, svgText, element, shadowRoot, container, svgElement, svgViewBox, viewBoxValues, bbox, calculatedViewBox;
          ...
          case 4:
            ...
            if (svgElement) {
              ...
              if (svgViewBox) {
                ...
                container.style.width = "".concat(viewBoxValues[2], "px");
                container.style.height = "".concat(viewBoxValues[3], "px");
              } else {
  ...
  return /* @__PURE__ */React__default["default"].createElement("div", {
    className: classNames__default["default"]("".concat(classPrefix, "-image-viewer__modal-pic"), innerClassName)
  }, /* @__PURE__ */React__default["default"].createElement("div", {
    ref: modalBoxRef,
...
var ImageViewerUtils = function ImageViewerUtils(_ref5) {
  ...
  return /* @__PURE__ */React__default["default"].createElement("div", {
    ...
    size: "medium",
    label: "".concat(number.largeNumberToFixed(String(scale * 100)), "%")
  }), /* @__PURE__ */React__default["default"].createElement(ImageModalIcon, {
    size: "medium",
    name: "zoom-in",
    onClick: onZoomIn
...
var ImageModal = function ImageModal(props) {
  ...
  var _useIndex = imageViewer_hooks_useIndex["default"](props, images),
    next = _useIndex.next,
    prev = _useIndex.prev;
  ...
  var imageItemRef = React.useRef(null);
  var handleWheelRef = React.useRef(null);
  var stableHandleWheel = React.useCallback(function (e) {
    var _handleWheelRef$curre;
    return (_handleWheelRef$curre = handleWheelRef.current) === null || _handleWheelRef$curre === void 0 ? void 0 : _handleWheelRef$curre.call(handleWheelRef, e);
  }, []);
  var _useScale = imageViewer_hooks_useScale["default"](imageScale, visible, stableHandleWheel),
    scale = _useScale.scale,
    onZoomIn = _useScale.onZoomIn,
    onZoomOut = _useScale.onZoomOut,
    onResetScale = _useScale.onResetScale;
  handleWheelRef.current = function (e) {
    var _imageItemRef$current;
    e.preventDefault();
    var isZoomOut = e.deltaY > 0;
    var container = containerRef.current;
    var modalBox = (_imageItemRef$current = imageItemRef.current) === null || _imageItemRef$current === void 0 || (_imageItemRef$current = _imageItemRef$current.modalBoxRef) === null || _imageItemRef$current === void 0 ? void 0 : _imageItemRef$current.current;
    if (isZoomOut && container && modalBox && transform.isImageExceedsViewport(container, modalBox)) {
      var _imageItemRef$current2, _imageItemRef$current3;
      var currentPosition = (_imageItemRef$current2 = (_imageItemRef$current3 = imageItemRef.current) === null || _imageItemRef$current3 === void 0 || (_imageItemRef$current3 = _imageItemRef$current3.positionRef) === null || _imageItemRef$current3 === void 0 ? void 0 : _imageItemRef$current3.current) !== null && _imageItemRef$current2 !== void 0 ? _imageItemRef$current2 : [0, 0];
      var result = onZoomOut({
        mouseOffsetX: 0,
        mouseOffsetY: 0,
        currentTranslate: {
      ...
      if (result !== null && result !== void 0 && result.newTranslate) {
        var _imageItemRef$current4, _imageItemRef$current5, _imageItemRef$current6, _imageItemRef$current7;
        (_imageItemRef$current4 = imageItemRef.current) === null || _imageItemRef$current4 === void 0 || (_imageItemRef$current5 = _imageItemRef$current4.enableTransition) === null || _imageItemRef$current5 === void 0 || _imageItemRef$current5.call(_imageItemRef$current4);
        (_imageItemRef$current6 = imageItemRef.current) === null || _imageItemRef$current6 === void 0 || (_imageItemRef$current7 = _imageItemRef$current6.setPosition) === null || _imageItemRef$current7 === void 0 || _imageItemRef$current7.call(_imageItemRef$current6, [result.newTranslate.translateX, result.newTranslate.translateY]);
      }
    } else {
  ...
  var onReset = React.useCallback(function () {
    var _imageItemRef$current8, _imageItemRef$current9;
    onResetScale();
    onResetRotate();
    onResetMirror();
    (_imageItemRef$current8 = imageItemRef.current) === null || _imageItemRef$current8 === void 0 || (_imageItemRef$current9 = _imageItemRef$current8.resetPosition) === null || _imageItemRef$current9 === void 0 || _imageItemRef$current9.call(_imageItemRef$current8);
  }, [onResetMirror, onResetScale, onResetRotate]);
  var keyHandlersRef = React.useRef({
    next: next,
    prev: prev,
    onZoomIn: onZoomIn,
    onZoomOut: onZoomOut,
  ...
  var onKeyDown = React.useCallback(function (event) {
    var _keyActionMap$event$k;
    var handlers = keyHandlersRef.current;
    var keyActionMap = {
      ...
      Escape: function Escape() {
        ...
        return handlers.closeOnEscKeydown && ((_handlers$onClose = handlers.onClose) === null || _handlers$onClose === void 0 ? void 0 : _handlers$onClose.call(handlers, {
          trigger: "esc",
          e: event
        }));
      }
    };
    (_keyActionMap$event$k = keyActionMap[event.key]) === null || _keyActionMap$event$k === void 0 || _keyActionMap$event$k.call(keyActionMap);
  }, []);
  React.useEffect(function () {
    if (!visible) return;
  ...
  if (closeBtn === true) {
    ...
    closeNode = isFunction.isFunction(closeBtn) ? closeBtn({
      onClose: onClose,
      onOpen: onOpen
    }) : closeBtn;
  }
  return /* @__PURE__ */React__default["default"].createElement("div", {
    ref: containerRef,
    className: classNames__default["default"]("".concat(classPrefix, "-image-viewer-preview-image"), defineProperty._defineProperty({}, "".concat(classPrefix, "-is-hide"), !visible), className),
    style: _objectSpread({
      zIndex: zIndex
    }, style)
...
//# sourceMappingURL=dep-3f3d9d07.js.map
