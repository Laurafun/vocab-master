...
var customParseFormat = require('./dep-6101c9a7.js');
var advancedFormat = require('./dep-d3391912.js');
...
var _stringToArray = require('./dep-95452e8e.js');
...
function createRange(fromRight) {
  return function (start, end, step) {
    ...
    start = advancedFormat.toFinite(start);
    if (end === undefined) {
      end = start;
      start = 0;
    } else {
      end = advancedFormat.toFinite(end);
    }
    step = step === undefined ? start < end ? 1 : -1 : advancedFormat.toFinite(step);
...
//# sourceMappingURL=dep-e8758e6e.js.map
