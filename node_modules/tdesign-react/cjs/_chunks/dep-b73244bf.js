...
var createClass = require('./dep-c4a7e637.js');
var log = require('./dep-0b6641db.js');
var treeNodeModel = require('./dep-c403c517.js');
var isNumber = require('./dep-e38e8bcb.js');
var isBoolean = require('./dep-116afad1.js');
var get = require('./dep-1a6a883d.js');
var isNull = require('./dep-73d0f7b5.js');
var toString = require('./dep-c854710a.js');
var isNil = require('./dep-7c762c12.js');
...
var TreeNode = /*#__PURE__*/function () {
  function TreeNode(tree, data, parent) {
    ...
    var nodeKey = this.getNodeMapKey();
    if (config !== null && config !== void 0 && config.allowDuplicateValue) {
      var siblings = this.parent ? this.parent.children : tree.children;
      if (Array.isArray(siblings)) {
        var hasDuplicate = siblings.some(function (sibling) {
          return sibling instanceof TreeNode && sibling.value === _this.value;
        });
        if (hasDuplicate) {
          log.log.warn("Tree", "Duplicated value in the same level: ".concat(this.value));
        }
      }
    } else if (nodeMap.get(nodeKey)) {
      log.log.warn("Tree", "Duplicated value: ".concat(this.value));
    }
  ...
  return createClass._createClass(TreeNode, [{
    ...
    value: function initChecked() {
      ...
      var checkedKey = this.getNodeMapKey();
      if (this.checked) {
    ...
    value: function initExpanded() {
      ...
      var config = tree.config;
      var expandedKey = this.getNodeMapKey();
    ...
    value: function appendTo(tree, parent, index) {
      ...
      nodes.forEach(function (item) {
        var node = item;
        node.tree = tree;
        var nodeKey = node.getNodeMapKey();
    ...
    key: "getNodeMapKey",
    value: function getNodeMapKey() {
      var allowDuplicateValue = this.tree.config.allowDuplicateValue;
      if (allowDuplicateValue) {
        return treeNodeModel.pathToKey(this.getPath().map(function (node) {
          return node.value;
        }));
      }
      return this.value;
    ...
    value: function isChecked(map) {
      ...
      var checked = false;
      if (checkedMap.get(nodeKey) && (valueMode !== "onlyLeaf" || this.isLeaf())) {
        return true;
      }
      if (Array.isArray(children) && children.length > 0) {
        ...
        checked = parents.some(function (node) {
          return checkedMap.get(node.getNodeMapKey());
        });
      }
      return checked;
    }
    ...
    value: function setActived(actived, opts) {
      ...
      var activedKey = this.getNodeMapKey();
      if (this.isActivable()) {
        if (actived) {
    ...
    value: function setChecked(checked, opts) {
      ...
      if (config.checkStrictly) {
        ...
        if (options.directly) {
          var relatedNodes = tree.getRelatedNodes([checkedKey], {
            reverse: true
          });
    ...
    value: function getModel() {
      ...
      if (!model) {
        model = treeNodeModel.createNodeModel(this);
        this.model = model;
      }
      treeNodeModel.updateNodeModel(model, this);
      return model;
    }
  }]);
}();
...
//# sourceMappingURL=dep-b73244bf.js.map
