...
var Watermark = function Watermark(originalProps) {
  ...
  var backgroundSize = React.useRef("".concat(gapX + width, "px"));
  ...
  React.useEffect(function () {
    generateBase64Url({
      ...
      var _ref = param || {},
        width2 = _ref.width;
      backgroundSize.current = width2 ? "".concat(width2, "px") : null;
      setBase64Url(url);
    });
  }, [width, height, rotate, zIndex, lineSpace, alpha, offsetLeft, offsetTop, gapX, gapY, watermarkContent, fontColor, layout]);
  React.useEffect(function () {
    styleStr.current = watermark_utils.getStyleStr(_objectSpread({
      ...
      backgroundSize: backgroundSize.current || "".concat(gapX + width, "px"),
      pointerEvents: "none",
