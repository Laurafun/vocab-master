...
var useDialogEsc = function useDialogEsc(visible, dialog) {
  var addedToStackRef = React.useRef(false);
  var focusTopDialog = React.useCallback(function () {
  ...
  var activateDialog = React.useCallback(function () {
    if (dialog !== null && dialog !== void 0 && dialog.current && !addedToStackRef.current) {
