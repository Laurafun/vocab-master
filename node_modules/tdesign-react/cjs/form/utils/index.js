...
var has = require('../../_chunks/dep-0814d62e.js');
...
function calcFieldValue(name, value) {
  ...
  if (!Array.isArray(name)) return defineProperty._defineProperty({}, name, value);
  var result = value;
  for (var i = name.length - 1; i >= 0; i--) {
    ...
    if (isNumberKey) {
      ...
      result = defineProperty._defineProperty({}, key, result);
    }
  }
  return result;
}
function travelMapFromObject(obj, formMapRef, callback) {
  ...
  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
      var _step3$value = slicedToArray._slicedToArray(_step3.value, 2),
        mapName = _step3$value[0],
        formItemRef = _step3$value[1];
      if (has.has(obj, mapName)) {
        callback(formItemRef, get.get(obj, mapName));
      }
    }
  } catch (err) {
    _iterator3.e(err);
...
exports.calcFieldValue = calcFieldValue;
exports.concatName = concatName;
exports.convertNameToArray = convertNameToArray;
exports.findFormItem = findFormItem;
exports.swap = swap;
exports.travelMapFromObject = travelMapFromObject;
