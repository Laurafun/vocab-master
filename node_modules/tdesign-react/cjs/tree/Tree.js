...
var tree_defaultProps = require('./defaultProps.js');
...
var Tree = /*#__PURE__*/React.forwardRef(function (originalProps, ref) {
  var _useControllable = tree_hooks_useControllable["default"](originalProps),
  ...
  var props = hooks_useDefaultProps["default"](originalProps, tree_defaultProps.treeDefaultProps);
  ...
  var _useTreeConfig = tree_hooks_useTreeConfig.useTreeConfig(transition),
  ...
  var handleChange = function handleChange(node, ctx) {
    ...
    var checked = node.toggleChecked();
    var treeNodeModel = node === null || node === void 0 ? void 0 : node.getModel();
    onChange === null || onChange === void 0 || onChange(checked, _objectSpread(_objectSpread({
      node: treeNodeModel
    }, ctx), {}, {
      trigger: "node-click"
    }));
  ...
  var renderEmpty = function renderEmpty() {
    return _util_parseTNode["default"](emptyText);
  };
