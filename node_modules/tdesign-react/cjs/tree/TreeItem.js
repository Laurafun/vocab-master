...
var TreeItem = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var renderLabel = function renderLabel() {
    ...
    if (node.isCheckable()) {
      ...
      return /* @__PURE__ */React__default["default"].createElement(checkbox_index.Checkbox, _objectSpread({
        ...
        onChange: function onChange(_, ctx) {
    ...
    var isCustomLabel = label instanceof Function || /*#__PURE__*/React.isValidElement(node.label);
    return /* @__PURE__ */React__default["default"].createElement("span", {
      ref: setRefCurrent,
      "data-target": "label",
      className: labelClasses,
      title: isCustomLabel ? void 0 : String(((_node$data = node.data) === null || _node$data === void 0 ? void 0 : _node$data.text) || node.label || "")
  ...
  return /* @__PURE__ */React__default["default"].createElement("div", {
    ref: _util_ref.composeRefs(ref, nodeRef),
