...
import { g as getDefaultFormat, f as formatDate, i as isValidDate, p as parseToDayjs } from '../../_chunks/dep-6a65d3f8.js';
import useConfig from '../../hooks/useConfig.js';
import useGlobalIcon from '../../hooks/useGlobalIcon.js';
import useInnerPopupVisible from '../../hooks/useInnerPopupVisible.js';
...
function useRange(props) {
  ...
  var isSwitchTimeMode = useMemo(function () {
    return isObject(props.enableTimePicker) && props.enableTimePicker.mode === "switch";
  ...
  var handleInnerVisibleChange = useInnerPopupVisible(function (visible, context) {
  ...
  var popupProps = _objectSpread(_objectSpread({
    ...
    overlayClassName: classNames((_props$popupProps4 = props.popupProps) === null || _props$popupProps4 === void 0 ? void 0 : _props$popupProps4.overlayClassName, "".concat(name, "__panel-container")),
