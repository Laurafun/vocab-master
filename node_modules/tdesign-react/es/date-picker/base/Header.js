...
var DatePickerHeader = function DatePickerHeader(props) {
  ...
  var initOptions = useCallback(function (year2) {
    ...
    if (mode === "year") {
      ...
      yearHasAnyAllowed(year2) && options.push({
        label: "".concat(year2),
        value: year2,
        disabled: false
      });
      for (var _i = 1; _i <= 10; _i++) {
        yearHasAnyAllowed(year2 + _i) && options.push({
          label: "".concat(year2 + _i),
          value: year2 + _i,
          disabled: false
        });
        yearHasAnyAllowed(year2 - _i) && options.unshift({
          label: "".concat(year2 - _i),
          value: year2 - _i,
          disabled: false
        });
  ...
  var showPanelTop = useMemo(function () {
    var options = yearOptions;
    if (!options.length) return false;
    var first = options[0].value;
    return canLoadMoreTop(first);
  }, [canLoadMoreTop, yearOptions]);
  var showPanelBottom = useMemo(function () {
    var options = yearOptions;
    if (!options.length) return false;
    ...
    if (mode === "year") {
      ...
      if (type === "add") {
        for (var i = year2 - extraYear + 10; i <= year2 - extraYear + 50; i += 10) {
          var end = i + 9;
          decadeHasAnyAllowed(end) && options.push({
            label: "".concat(i, " - ").concat(end),
            value: i,
            disabled: false
          });
        ...
        for (var _i2 = year2 - extraYear - 1; _i2 > year2 - extraYear - 50; _i2 -= 10) {
          decadeHasAnyAllowed(_i2) && options.unshift({
      ...
      for (var _i3 = year2 + 1; _i3 <= year2 + 10; _i3++) {
        yearHasAnyAllowed(_i3) && options.push({
          label: "".concat(_i3),
          value: _i3,
          disabled: false
        });
      ...
      for (var _i4 = year2 - 1; _i4 > year2 - 10; _i4--) {
        yearHasAnyAllowed(_i4) && options.unshift({
          label: "".concat(_i4),
          value: _i4,
          disabled: false
        });
  ...
  function handleUpdateScrollTop(content) {
    if (scrollAnchorRef.current === "top") {
      ...
      var firstSelectedNode = content === null || content === void 0 ? void 0 : content.querySelector(".".concat(classPrefix, "-is-selected"));
  ...
  return /* @__PURE__ */React.createElement("div", {
    ...
    popupProps: {
      ...
      updateScrollTop: function updateScrollTop(el) {
        setTimeout(function () {
    ...
    panelTopContent: showPanelTop && /* @__PURE__ */React.createElement("div", {
      className: "".concat(classPrefix, "-select-option"),
      onClick: handlePanelTopClick
    }, "..."),
    panelBottomContent: showPanelBottom && /* @__PURE__ */React.createElement("div", {
      className: "".concat(classPrefix, "-select-option"),
