...
import { g as getDefaultFormat, p as parseToDayjs, a as formatTime, f as formatDate } from '../_chunks/dep-6a65d3f8.js';
import { s as subtractMonth, a as addMonth, e as extractTimeObj } from '../_chunks/dep-2a9927d7.js';
...
var DateRangePickerPanel = /*#__PURE__*/forwardRef(function (originalProps, ref) {
  ...
  var handleSyncPanelValue = function handleSyncPanelValue(value2) {
    ...
    setMonth(nextMonth);
    setYear(nextYear);
    setTime(formatTime(value2, format, timeFormat, props.defaultTime));
  };
  ...
  function onPresetClick(presetValue, context) {
    ...
    if (!Array.isArray(presetVal)) {
      ...
      var formattedPreset = formatDate(presetVal, {
        format: format
      });
