...
import { _ as _classCallCheck, a as _createClass } from '../../_chunks/dep-8b29d628.js';
...
var Truncate = /*#__PURE__*/function (_React$Component) {
  function Truncate(props) {
    ...
    _defineProperty(_this, "escapeHtml", function (html) {
    ...
    _defineProperty(_this, "breakAtWordBoundary", function (text) {
      var wordBoundaryMatch = text.match(/^(.*[\s\-,;.!?])/);
      if (wordBoundaryMatch) {
        var _wordBoundaryMatch = _slicedToArray(wordBoundaryMatch, 2),
