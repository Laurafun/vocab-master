...
import { DATA_PARENT_ID_ATTR } from './hooks/useDragSort.js';
...
import { enableRowDrag } from './utils.js';
...
var EnhancedTable = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  var primaryTableProps = _objectSpread(_objectSpread(_objectSpread({}, props), {}, {
    data: dataSource,
    columns: tColumns,
    ...
    rowClassName: function rowClassName(_ref) {
      ...
      var classNames = [props.rowClassName, "".concat(classPrefix, "-table-tr--level-").concat(rowState.level)];
    ...
    rowAttributes: function rowAttributes(params) {
      var row = params.row;
      var rowValue = get(row, props.rowKey);
      var rowState = treeDataMap.get(rowValue);
      var originalAttrs = typeof props.rowAttributes === "function" ? props.rowAttributes(params) : props.rowAttributes || {};
      var formatAttrs = !Array.isArray(originalAttrs) ? _objectSpread({}, originalAttrs) : {};
      if (rowState !== null && rowState !== void 0 && rowState.parent) {
