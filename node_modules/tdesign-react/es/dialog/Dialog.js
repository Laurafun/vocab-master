...
import { p as pxCompat } from '../_chunks/dep-d88b4bd9.js';
...
var Dialog = /*#__PURE__*/forwardRef(function (originalProps, ref) {
  var _globalDialogConfig$p;
  var _useConfig = useConfig(),
    classPrefix = _useConfig.classPrefix,
    globalDialogConfig = _useConfig.dialog;
  var props = useDefaultProps(originalProps, _objectSpread(_objectSpread({}, dialogDefaultProps), {}, {
    placement: (_globalDialogConfig$p = globalDialogConfig === null || globalDialogConfig === void 0 ? void 0 : globalDialogConfig.placement) !== null && _globalDialogConfig$p !== void 0 ? _globalDialogConfig$p : dialogDefaultProps.placement,
    zIndex: globalDialogConfig === null || globalDialogConfig === void 0 ? void 0 : globalDialogConfig.zIndex
  }));
  ...
  var isModeless = mode === "modeless";
  var isFullScreen = mode === "full-screen";
  var dialogAttach = useAttach("dialog", attach);
  var _useState = useState(false),
    _useState2 = _slicedToArray(_useState, 2),
    dialogAnimationVisible = _useState2[0],
    setDialogAnimationVisible = _useState2[1];
  useDialogLockStyle({
  ...
  var _useDialogEsc = useDialogEsc(visible, wrapRef),
    activateDialog = _useDialogEsc.activateDialog;
  var _useDialogPosition = useDialogPosition(dialogCardRef),
    applyTransform = _useDialogPosition.applyTransform;
  var _useDialogDrag = useDialogDrag({
      dialogCardRef: dialogCardRef,
      canDraggable: !isFullScreen && draggable
    }),
    isInputInteracting = _useDialogDrag.isInputInteracting;
  ...
  var onMaskClick = function onMaskClick(e) {
    ...
    if (closeOnOverlayClick !== null && closeOnOverlayClick !== void 0 ? closeOnOverlayClick : local.closeOnOverlayClick) {
  ...
  return /* @__PURE__ */React.createElement(CSSTransition, {
    ...
    ref: wrapRef,
    className: classNames(className, "".concat(componentCls, "__ctx"), "".concat(componentCls, "__").concat(mode), _defineProperty(_defineProperty(_defineProperty({}, "".concat(componentCls, "__ctx--fixed"), !showInAttachedElement), "".concat(componentCls, "__ctx--absolute"), showInAttachedElement), "".concat(componentCls, "__ctx--modeless"), isModeless)),
    style: {
      zIndex: zIndex
    },
    ...
    ref: dialogPosition,
    className: classNames(isFullScreen ? "".concat(componentCls, "__position_fullscreen") : "".concat(componentCls, "__position"), _defineProperty(_defineProperty({}, "".concat(componentCls, "--top"), !isFullScreen && (!!top || placement === "top")), "".concat(componentCls, "--center"), !isFullScreen && placement === "center" && !top)),
    style: {
      paddingTop: isFullScreen ? void 0 : pxCompat(top)
    },
    onClick: onMaskClick
    ...
    style: _objectSpread(_objectSpread({}, style), {}, {
      width: pxCompat(width || (style === null || style === void 0 ? void 0 : style.width))
    }),
    onConfirm: onConfirm,
