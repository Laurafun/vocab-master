...
import '../tag/type.js';
import './utils/tagInputScroll.js';
...
var TagInput = /*#__PURE__*/forwardRef(function (originalProps, ref) {
  ...
  var suffixWidthRef = useRef(0);
  var suffixIconWidthRef = useRef(0);
  ...
  return /* @__PURE__ */React.createElement(Input, _objectSpread(_objectSpread({
    ...
    onKeydown: onKeydown,
    onKeyup: onKeyup,
    className: classNames(classes, inputProps === null || inputProps === void 0 ? void 0 : inputProps.className)
  }));
});
