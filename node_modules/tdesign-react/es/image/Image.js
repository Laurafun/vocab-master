...
import { o as observe } from '../_chunks/dep-f7b4b587.js';
...
var InternalImage = function InternalImage(originalProps, ref) {
  ...
  return /* @__PURE__ */React.createElement("div", _objectSpread(_objectSpread({
    ...
    size: 8,
    align: "center"
  }, /* @__PURE__ */React.createElement(ImageIcon$1, null), typeof loading === "string" ? loading : t(local.loadingText)))), hasError && /* @__PURE__ */React.createElement("div", {
    className: "".concat(classPrefix, "-image__error")
  }, error || /* @__PURE__ */React.createElement(Space, {
    direction: "vertical",
    size: 8,
    align: "center"
  }, /* @__PURE__ */React.createElement(ImageErrorIcon$1, null), typeof error === "string" ? error : t(local.errorText))), renderOverlay());
};
