...
import { calculatePaddingLeft } from './_util/calculatePaddingLeft.js';
...
var SubAccordion = function SubAccordion(props) {
  ...
  var _useControlled = useControlled(popupProps, "visible", restPopupProps.onVisibleChange),
  ...
  var menuPaddingLeft = calculatePaddingLeft(level - 1);
...
var SubTitleMenu = function SubTitleMenu(props) {
  ...
  var _useControlled3 = useControlled(popupProps, "visible", restPopupProps.onVisibleChange),
  ...
  var pupContent = /* @__PURE__ */React.createElement("ul", {
    className: classNames("".concat(classPrefix, "-menu__popup-wrapper"), "".concat(classPrefix, "-menu__popup-overflow"), _defineProperty({}, "".concat(classPrefix, "-is-opened"), isOpen))
  }, children);
  ...
  var submenu = /* @__PURE__ */React.createElement("li", {
    ...
    className: "".concat(classPrefix, "-menu__content")
  }, title), isPopUp && /* @__PURE__ */React.createElement(FakeArrow, {
    style: fakeArrowStyle,
