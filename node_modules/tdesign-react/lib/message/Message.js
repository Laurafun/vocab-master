...
import { M as MessageComponent, f as fadeOut } from '../_chunks/dep-99b87fd4.js';
export { M as default } from '../_chunks/dep-99b87fd4.js';
import { P as PLACEMENT_OFFSET } from '../_chunks/dep-adb31c6e.js';
import { g as getAttach } from '../_chunks/dep-8b450243.js';
...
function createContainer(placement, attachNode, zIndex) {
...
function renderContainer(containerInstance) {
  ...
  render(/* @__PURE__ */React.createElement(PluginContainer, {
    ...
    zIndex: containerInstance.zIndex
...
function renderElement(theme, config) {
  ...
  if (!containerInstance) {
    var container = createContainer(placement, attachNode, zIndex);
    containerInstance = {
      container: container,
      messages: [],
      placement: placement,
