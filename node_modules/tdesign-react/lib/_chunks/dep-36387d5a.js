...
import { _ as _toConsumableArray } from './dep-5fc4ab77.js';
import { _ as _createClass, a as _classCallCheck } from './dep-5cf2d12a.js';
import { isNumber, isBoolean, get, isNull, uniqueId, isNil, isFunction } from 'lodash-es';
import { l as log } from './dep-5e8b3e6e.js';
import { p as pathToKey, c as createNodeModel, u as updateNodeModel } from './dep-51a88252.js';
  ...
  function TreeNode(tree, data, parent) {
    ...
    if (config !== null && config !== void 0 && config.allowDuplicateValue) {
      ...
      if (Array.isArray(siblings)) {
        ...
        if (hasDuplicate) {
          log.warn("Tree", "Duplicated value in the same level: ".concat(this.value));
        }
      }
    } else if (nodeMap.get(nodeKey)) {
      log.warn("Tree", "Duplicated value: ".concat(this.value));
    }
  ...
  return _createClass(TreeNode, [{
    ...
    value: function getNodeMapKey() {
      ...
      if (allowDuplicateValue) {
        return pathToKey(this.getPath().map(function (node) {
          return node.value;
        }));
      }
      return this.value;
...
//# sourceMappingURL=dep-36387d5a.js.map
