...
import React, { forwardRef, useRef, useState, useMemo, useImperativeHandle, isValidElement } from 'react';
import { CSSTransition } from 'react-transition-group';
import classNames from 'classnames';
import { isUndefined, isString, isObject, isFunction } from 'lodash-es';
...
var Drawer = /*#__PURE__*/forwardRef(function (originalProps, ref) {
  ...
  var className = state.className,
    ...
    lazy = state.lazy;
  var onBeforeOpen = props.onBeforeOpen,
    ...
    onSizeDragEnd = props.onSizeDragEnd;
