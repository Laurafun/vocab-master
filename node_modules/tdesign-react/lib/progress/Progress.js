...
import React, { forwardRef, useRef, useState, useCallback, useEffect, isValidElement } from 'react';
...
import { g as getBackgroundColor } from '../_chunks/dep-de62a4e1.js';
...
var Progress = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  if (theme === "plump") {
    progressDom = /* @__PURE__ */React.createElement("div", {
      ref: ref,
      className: classNames("".concat(classPrefix, "-progress__bar"), "".concat(classPrefix, "-progress--plump"), _defineProperty(_defineProperty(_defineProperty({}, "".concat(statusClassName), status), "".concat(classPrefix, "-progress--over-ten"), labelPosition === "inside"), "".concat(classPrefix, "-progress--under-ten"), labelPosition === "outside")),
      style: trackStyle
    }, labelPosition === "inside" ? /* @__PURE__ */React.createElement("div", {
      ref: innerRef,
    ...
    }, /*#__PURE__*/isValidElement(label) ? label : "".concat(percentage, "%"))) : /* @__PURE__ */React.createElement(React.Fragment, null, /* @__PURE__ */React.createElement("div", {
      ref: innerRef,
      className: "".concat(classPrefix, "-progress__inner"),
      style: barStyle
    }), label && /* @__PURE__ */React.createElement("div", {
      ref: labelRef,
      className: "".concat(classPrefix, "-progress__info")
    }, /*#__PURE__*/isValidElement(label) ? label : "".concat(percentage, "%"))));
  } else {
    progressDom = /* @__PURE__ */React.createElement("div", {
      ref: ref,
