...
import { xorWith, pick, get } from 'lodash-es';
import { l as log } from '../../_chunks/dep-5e8b3e6e.js';
import { a as getScrollbarWidthWithCSS } from '../../_chunks/dep-e7558ecd.js';
import { b as getIEVersion } from '../../_chunks/dep-de62a4e1.js';
import { on, off } from '../../_util/listener.js';
import useDeepEffect from '../../hooks/useDeepEffect.js';
import usePrevious from '../../hooks/usePrevious.js';
import { resizeObserverElement } from '../utils.js';
...
function useFixed(props, finalColumns, affixRef) {
  ...
  useDeepEffect(updateFixedStatus, [data, columns, bordered, tableLayout, tableContentWidth, isFixedHeader, isWidthOverflow, isFixedColumn, fixedRows, firstFullRow, lastFullRow, tableContentRef]);
  ...
  useEffect(function () {
    ...
    on(document, "animationend", onAnimationEnd, {
      capture: true
    });
    return function () {
      off(document, "animationend", onAnimationEnd, {
        capture: true
      });
    };
  }, []);
