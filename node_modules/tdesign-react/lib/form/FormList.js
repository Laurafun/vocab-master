...
import { get, cloneDeep, set, merge, isEqual, unset, castArray } from 'lodash-es';
...
import { concatName, convertNameToArray, swap, calcFieldValue } from './utils/index.js';
...
var FormList = function FormList(props) {
  ...
  function setListFields(fieldData, callback) {
    ...
    var newFieldData = _toConsumableArray(fieldData);
    ...
    Array.from(formListMapRef.current.values()).forEach(function (formItemRef) {
      ...
      var data = get(newFieldData, childName);
  ...
  useEffect(function () {
    ...
    set(form === null || form === void 0 ? void 0 : form.store, fullPath, formListValue);
    return function () {
  ...
  useImperativeHandle(formListRef, function () {
    return {
      ...
      getValue: function getValue() {
        return cloneDeep(get(form === null || form === void 0 ? void 0 : form.store, fullPath));
      },
      ...
      resetField: function resetField(type) {
        ...
        if (resetType === "initial") {
          ...
          set(form === null || form === void 0 ? void 0 : form.store, fullPath, initialData);
