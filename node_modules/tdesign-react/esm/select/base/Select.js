...
import { extractTextFromTNode, parseContentTNode } from '../../_util/parseTNode.js';
...
import { g as getKeyMapping, u as useOptions, i as isSelectOptionGroup, a as getSelectedOptions, b as getSelectValueArr, O as Option } from '../../_chunks/dep-069b7bf7.js';
...
var Select = forwardRefWithStatics(function (originalProps, ref) {
  ...
  var handleFilter = function handleFilter(value2) {
    ...
    var filterMethods = function filterMethods(option) {
      ...
      var searchableText = extractTextFromTNode(option.label);
