...
import { isDate, isArray } from 'lodash-es';
import { g as getDefaultFormat, f as formatDate, p as parseToDayjs, a as formatTime } from '../_chunks/dep-6a65d3f8.js';
import { c as covertToDate, g as getRangeBounds, s as subtractMonth, a as addMonth, e as extractTimeObj, i as isSame } from '../_chunks/dep-2a9927d7.js';
...
import { triggerMap } from './utils.js';
  ...
  useEffect(function () {
    ...
    if (popupVisible) {
      if ((props.range && isArray(props.range) || props.panelActiveDate) && !value) {
        ...
        var rangeBounds = getRangeBounds(props.range);
