...
import { g as getDefaultFormat, p as parseToDayjs, i as isValidDate, f as formatDate, a as formatTime, b as initYearMonthTime } from '../_chunks/dep-6a65d3f8.js';
import { g as getRangeBounds, s as subtractMonth, a as addMonth, e as extractTimeObj } from '../_chunks/dep-2a9927d7.js';
...
import { dateCorrection, triggerMap } from './utils.js';
...
import '../_chunks/dep-64b43cc6.js';
import '../_chunks/dep-6539a196.js';
...
import '../_chunks/dep-0a4b00bb.js';
...
import '../_chunks/dep-a04e6081.js';
import '../tag/defaultProps.js';
import '../tag/Tag.js';
import '../_chunks/dep-15113718.js';
import '../tag/CheckTagGroup.js';
import '../tag/type.js';
import '../tag-input/useTagScroll.js';
import '../tag-input/utils/tagInputScroll.js';
...
import '../_chunks/dep-49425d47.js';
...
import '../_chunks/dep-069b7bf7.js';
...
var DateRangePicker = /*#__PURE__*/forwardRef(function (originalProps, ref) {
      ...
      if (!value.length) {
        if (range && isArray(range) || panelActiveDate) {
          ...
          if (isArray(panelActiveDate)) {
            var _panelActiveDate = _slicedToArray(panelActiveDate, 2);
  ...
  function onTimePickerChange(val, context) {
    ...
    var currentDate = !dayjs(changedInputValue, format).isValid() ? dayjs().year(year[currentIndex]).month(month[currentIndex]) : dayjs(changedInputValue, format);
    var nextHours = hours;
