...
import { g as getRangeBounds, m as monthHasAnyAllowed, y as yearHasAnyAllowed, l as decadeHasAnyAllowed, n as computePaginationDisabled } from '../../_chunks/dep-2a9927d7.js';
...
function useSelectRange(props) {
  var rangeBounds = useMemo(function () {
  ...
  var paginationDisabled = useMemo(function () {
    return computePaginationDisabled(props.range, props.mode, props.year, props.month);
  }, [props]);
  var canLoadMoreTop = function canLoadMoreTop(firstValue) {
    var min = rangeBounds.min;
