...
import { _ as _objectWithoutProperties } from './dep-092ecef1.js';
import { _ as _typeof } from './dep-21b92b27.js';
...
var _excluded = ["onChange", "disabled", "className", "style", "children", "max", "options"];
...
var CheckboxGroup = function CheckboxGroup(props) {
  ...
  var _useDefaultProps = useDefaultProps(props, checkboxGroupDefaultProps),
    ...
    resetProps = _objectWithoutProperties(_useDefaultProps, _excluded);
  var readOnly = resetProps.readOnly || resetProps.readonly;
  var intervalOptions = Array.isArray(options) && options.length > 0 ? options : React.Children.map(children, function (child) {
    var _child$type;
    return (child === null || child === void 0 || (_child$type = child.type) === null || _child$type === void 0 ? void 0 : _child$type.displayName) === _Checkbox.displayName && child.props;
  }) || [];
  ...
  var _useMemo = useMemo(function () {
      ...
      optionsWithoutCheckAll.forEach(function (option) {
        var isOptionDisabled = _typeof(option) === "object" && (option.disabled || option.readOnly || option.readonly);
  ...
  var indeterminate = useMemo(function () {
    var allValues = [].concat(_toConsumableArray(enabledValues), _toConsumableArray(disabledValues));
  ...
  return /* @__PURE__ */React.createElement("div", {
    ...
    switch (_typeof(v)) {
      ...
      case "object":
        {
          var vs = v;
          return vs.checkAll ? /* @__PURE__ */React.createElement(_Checkbox, _objectSpread$1(_objectSpread$1({}, vs), {}, {
            key: "checkAll_".concat(index),
            indeterminate: indeterminate
          })) : /* @__PURE__ */React.createElement(_Checkbox, _objectSpread$1(_objectSpread$1({}, vs), {}, {
            key: index,
...
export { CheckboxGroup as C, _Checkbox as _ };
//# sourceMappingURL=dep-50ed5c2d.js.map
