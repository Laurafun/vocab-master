...
import { _ as _defineProperty } from './dep-a39b85f1.js';
import { _ as _asyncToGenerator, r as regenerator } from './dep-e3e970c5.js';
import { _ as _slicedToArray } from './dep-0a2d2078.js';
...
import { i as isImageExceedsViewport } from './dep-89c5305b.js';
import { l as largeNumberToFixed } from './dep-49425d47.js';
...
var ImageModalMini = function ImageModalMini(props) {
  ...
  return /* @__PURE__ */React.createElement(Dialog, {
    className: classNames("".concat(classPrefix, "-image-viewer__dialog"), className),
    ...
    footer: footer,
    onClose: onClose
  }, /* @__PURE__ */React.createElement(ImageModalMiniContent, _objectSpread$1({}, props)));
};
...
var ImageModalItem = /*#__PURE__*/React.forwardRef(function (_ref2, ref) {
  ...
  var transitionEndHandlerRef = useRef(null);
  var fallbackTimerRef = useRef();
  var cleanupTransition = useCallback(function () {
  ...
  var createSvgShadow = useCallback(/*#__PURE__*/function () {
  ...
  return /* @__PURE__ */React.createElement("div", {
    className: classNames("".concat(classPrefix, "-image-viewer__modal-pic"), innerClassName)
  }, /* @__PURE__ */React.createElement("div", {
    ref: modalBoxRef,
...
var ImageModal = function ImageModal(props) {
  ...
  var imageItemRef = useRef(null);
  var handleWheelRef = useRef(null);
  var stableHandleWheel = useCallback(function (e) {
  ...
  var _useScale = useScale(imageScale, visible, stableHandleWheel),
  ...
  if (closeBtn === true) {
    ...
    closeNode = isFunction(closeBtn) ? closeBtn({
      onClose: onClose,
      onOpen: onOpen
    }) : closeBtn;
  }
  return /* @__PURE__ */React.createElement("div", {
    ref: containerRef,
    className: classNames("".concat(classPrefix, "-image-viewer-preview-image"), _defineProperty({}, "".concat(classPrefix, "-is-hide"), !visible), className),
    style: _objectSpread({
      zIndex: zIndex
    }, style)
...
export { ImageModal as I, ImageModalMiniContent as a, ImageModalMini as b, ImageModalItem as c, ImageViewerUtils as d, formatImages as f };
//# sourceMappingURL=dep-8a04a3bb.js.map
