...
import { _ as _toConsumableArray } from '../../_chunks/dep-5fc4ab77.js';
import { _ as _defineProperty } from '../../_chunks/dep-a39b85f1.js';
import { _ as _slicedToArray } from '../../_chunks/dep-0a2d2078.js';
import { useState, useMemo, useRef, useEffect } from 'react';
import { get } from 'lodash-es';
import Sortable from 'sortablejs';
import '../../_chunks/dep-72fbfd9b.js';
import { g as getColumnDataByKey, a as getColumnIndexByKey } from '../../_chunks/dep-66b94626.js';
import { h as hasClass } from '../../_chunks/dep-4ca16085.js';
import useLatest from '../../hooks/useLatest.js';
import useClassName from './useClassName.js';
import { l as log } from '../../_chunks/dep-5e8b3e6e.js';
import '../../_chunks/dep-f0bfb011.js';
import '../../_chunks/dep-61ec84a8.js';
import '../../_chunks/dep-21b92b27.js';
import '../../_chunks/dep-351f9efc.js';
...
function useDragSort(props, options) {
  ...
  var dragRowInstance = useRef(null);
  var dragColInstance = useRef(null);
  var trIdList = useRef([]);
  var lastColIdList = useRef([]);
  ...
  var getValidSiblingId = function getValidSiblingId(el, dir) {
    ...
    while (node) {
      ...
      var isFullRow = hasClass(node, tableFullRowClasses.base);
  ...
  var registerRowDragEvent = function registerRowDragEvent(element) {
    ...
    var baseOptions = _objectSpread({
      ...
      onMove: function onMove(evt) {
        var isFullRow = hasClass(evt.related, tableFullRowClasses.base);
        if (isFullRow) return false;
        var related = evt.related,
          dragged = evt.dragged,
          willInsertAfter = evt.willInsertAfter;
        var isTargetExpandedParent = hasClass(related, tableExpandClasses.expanded);
        var isTargetExpandedChild = hasClass(related, tableExpandClasses.row);
      ...
      onEnd: function onEnd(evt) {
        try {
          ...
          var newData = swapDragArrayElement(_toConsumableArray(tData.current), swapCurrent, swapTarget);
          var params = {
    ...
    try {
      if (isRowDraggable) {
        dragRowInstance.current = new Sortable(dragContainer, _objectSpread({}, baseOptions));
      } else if (isRowHandlerDraggable) {
        dragRowInstance.current = new Sortable(dragContainer, _objectSpread(_objectSpread({}, baseOptions), {}, {
  ...
  var registerOneLevelColDragEvent = function registerOneLevelColDragEvent(container, recover) {
    var options2 = _objectSpread({
      ...
      onEnd: function onEnd(evt) {
        ...
        if (recover) {
          ...
          (_dragColInstance$curr = dragColInstance.current) === null || _dragColInstance$curr === void 0 || _dragColInstance$curr.sort(_toConsumableArray(lastColIdList.current));
        }
    ...
    if (!container) return;
    dragColInstance.current = new Sortable(container, options2);
...
export { DATA_ID_ATTR, DATA_PARENT_ID_ATTR, EXPANDED_SUFFIX, useDragSort as default };
