...
import { i as isFirefox, c as isSafari, b as getIEVersion } from '../_chunks/dep-d88b4bd9.js';
import { Affix } from '../affix/index.js';
import useDefaultProps from '../hooks/useDefaultProps.js';
import useDomRefMount from '../hooks/useDomRefMount.js';
...
import '../_chunks/dep-f7b4b587.js';
...
import '../_chunks/dep-feddee9e.js';
...
var BaseTable = /*#__PURE__*/forwardRef(function (originalProps, ref) {
  ...
  var _useDomRefMount = useDomRefMount(affixHeaderRef),
    ...
    return /* @__PURE__ */React.createElement("colgroup", null, finalColumns.map(function (col, index) {
      ...
      if (col.minWidth) {
        if (supportMinWidth) {
          ...
          style2.width = formatCSSUnit(col.minWidth);
        }
      }
  ...
  var renderFixedHeader = function renderFixedHeader() {
    ...
    var affixedHeader = Boolean((headerAffixedTop || virtualConfig.isVirtualScroll) && tableWidth) && /* @__PURE__ */React.createElement("div", {
  ...
  var renderAffixedFooter = function renderAffixedFooter() {
    ...
    var affixedFooter = Boolean((virtualConfig.isVirtualScroll || props.footerAffixedBottom) && hasFooter && tableWidth) && /* @__PURE__ */React.createElement(Affix, _objectSpread(_objectSpread({
  ...
  var affixedHeaderContent = useMemo(renderAffixedHeader, [].concat(headUseMemoDependencies, [showAffixHeader, tableWidth, tableElmWidth, affixHeaderRef, borderWidth, tableElmClasses, tableElementStyles, columns, showHeader, props.headerAffixedTop]));
