...
import { d as calculateNodeSize, e as getUnicodeLength, f as getCharacterLength, l as limitUnicodeMaxLength } from '../_chunks/dep-d88b4bd9.js';
...
var _excluded = ["count", "disabled", "maxlength", "maxcharacter", "className", "autofocus", "style", "onKeydown", "onKeypress", "onKeyup", "autosize", "status", "tips", "allowInputOverMax", "rows"];
...
var OMIT_PROPS = ["defaultValue", "readonly"];
var Textarea = /*#__PURE__*/forwardRef(function (originalProps, ref) {
  ...
  var textareaPropsNames = Object.keys(otherProps).filter(function (key) {
    return !/^on[A-Z]/.test(key) && !OMIT_PROPS.includes(key);
  });
  ...
  var textareaClassNames = classNames("".concat(classPrefix, "-textarea__inner"), className, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(classPrefix, "-is-").concat(status), status), "".concat(classPrefix, "-is-disabled"), disabled), "".concat(classPrefix, "-is-focused"), isFocused), "".concat(classPrefix, "-resize-none"), _typeof(autosize) === "object"), "".concat(classPrefix, "-hide-scrollbar"), autosize === true));
  ...
  var renderLimitText = function renderLimitText(current, max) {
    ...
    if (typeof count === "function") {
      return parseTNode(count, {
        value: value,
        count: current,
        maxLength: hasMaxcharacter ? void 0 : maxlength,
        maxCharacter: hasMaxcharacter ? maxcharacter : void 0
      });
    }
    if (!max) return;
  ...
  var textTips = tips && /* @__PURE__ */React.createElement("div", {
    className: classNames("".concat(classPrefix, "-textarea__tips"), _defineProperty({}, "".concat(classPrefix, "-textarea__tips--").concat(status), status))
  }, tips);
  var limitText = renderLimitText(hasMaxcharacter ? characterLength : currentLength, hasMaxcharacter ? maxcharacter : maxlength);
